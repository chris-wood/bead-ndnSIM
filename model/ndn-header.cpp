...
template<>
ns3::TypeId
PacketHeader<Bead>::GetTypeId()
{
  static ns3::TypeId tid =
    ns3::TypeId("ns3::ndn::Bead")
    .SetGroupName("Ndn")
    .SetParent<Header>()
    .AddConstructor<PacketHeader<Bead>>()
    ;
  return tid;
}
...
template<>
void
PacketHeader<Bead>::Print(std::ostream& os) const
{
  os << "B: " << *m_packet;
}
